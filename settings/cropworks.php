        ...
        <div class="titlesection clearfix">
          <div class="tabbing-section">
            <ul>
                ...
                <li><a href="<?php echo home_base_url(); ?>/settings/worktypes.php">Work Types</a></li>
                <li><a href="<?php echo home_base_url(); ?>/settings/cropworks.php" class="active">Crop Work</a></li>
            </ul>
          </div>   
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 padding0 equpiment">
            <h3 class="margin0">Work Types</h3> <br>&nbsp;<br>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding0 users"><a class="addusers addplusicon pull-right" href="<?php echo home_base_url(); ?>cropworks/add.php" title="Add Type"><i class="fa fa-plus" aria-hidden="true"></i> Add Work</a></div>
        </div>
