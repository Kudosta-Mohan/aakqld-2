...
{ 
  ...
  {  
    try
    {
      if($setting->updateWorkType($wtname, $id)) 
      {
          $setting->redirect('edit.php?id='.$id.'&action=edit&joined');
      }
...
$id = $_GET['id'];
$workTypeDetail = $setting->getWorkTypeDetial($id);
?>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
        <div class="titlesection row">   
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 equipment"><h1 class="margin0">Edit Work Type</h1></div>
        ...
        <div class="addnewuserform">
          <form role="form" method="post" id="add_users" class="add_users">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <input type="text" class="form-control" id="wtname" name="wtname" placeholder="Enter Work Type" value="<?php echo $workTypeDetail['type_name']; ?>">
            </div>
            <input type="hidden" name="worktype_id" value="<?php echo $workTypeDetail['id']; ?>">
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
